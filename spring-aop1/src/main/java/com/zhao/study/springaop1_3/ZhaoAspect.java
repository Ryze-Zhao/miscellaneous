...
public class ZhaoAspect {
    ...
    @Pointcut(value = "execution(* com.zhao.study.springaop1_3.service.AccountService..*(..))")
    ...
    @Pointcut(value = "within(com.zhao.study.springaop1_3.service.*)")
    ...
    @Pointcut(value = "this(com.zhao.study.springaop1_3.service.AccountService)")
    ...
    @Pointcut(value = "target(com.zhao.study.springaop1_3.service.AccountService)")
    ...
    @Pointcut(value = "@within(com.zhao.study.springaop1_3.MyAnnotation)")
    public void theEleventhCut() {

    }

    //代表使用了@MyAnnotation注解的方法
    @Pointcut(value = "@annotation(com.zhao.study.springaop1_3.MyAnnotation)")
    public void theTwelfthCut() {

    }

    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theFirstCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theSecondCut()")
    public void theSecondCutBefore() {
        System.out.println("TheSecondCut:::::before-----------(名称以set开头的任何方法的执行)-----------（针对setQuery()）");
    }

    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theThirdCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theFourthCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theFifthCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theSixthCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theEighthCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theNinthCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theTenthCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theEleventhCut()")
    ...
    @Before("com.zhao.study.springaop1_3.ZhaoAspect.theTwelfthCut()")
